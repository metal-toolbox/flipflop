...
LDFLAG_LOCATION := github.com/metal-toolbox/flipflop/internal/version
...
DOCKER_IMAGE  := "ghcr.io/metal-toolbox/flipflop"
REPO := "https://github.com/metal-toolbox/flipflop.git"
...
push-image-devel: build-image
	docker tag ${DOCKER_IMAGE}:latest localhost:5001/flipflop:latest
	docker push localhost:5001/flipflop:latest
	kind load docker-image localhost:5001/flipflop:latest
